...
public static class AppStrings
{
    private static readonly Dictionary<string, string> SpanishToEnglish = new(StringComparer.Ordinal)
    {
        ...
        ["Deadline de picks"] = "Picks deadline",
        ["Fin de la ventana de bans"] = "Ban window closes",
        ["Lista de picks vacia!"] = "Pick list is empty!",
        ["Lista de picks incompleta"] = "Pick list is incomplete",
        ["Lista aun no actualizada este GP"] = "Pick list hasn't been updated for this GP yet",
        ["Estado"] = "Status",
        ["Recogiendo listas"] = "Collecting lists",
        ["Resultado publicado"] = "Result published",
        ["Resultado definitivo"] = "Final result",
        ["Cancelado"] = "Cancelled",
        ["Missed pick"] = "Missed pick",
        ["Elegir ban"] = "Choose ban",
        ["No hay picks rivales elegibles para banear."] = "There are no eligible rival picks to ban.",
        ["Jugador y pick"] = "Player and pick",
        ["Selecciona un pick"] = "Select a pick",
        ["El ban de {0} con {1} no se puede deshacer. El resultado completo puede cambiar."] = "Banning {0}'s {1} pick cannot be undone. The full result may change.",
        ["Baneando..."] = "Banning...",
        ["Continuar"] = "Continue",
        ["Mis picks"] = "My picks",
        ["Cargando picks..."] = "Loading picks...",
        ["Orden de preferencia"] = "Preference order",
        ["Quitar"] = "Remove",
        ["Vaciar lista"] = "Clear list",
        ["Agregar piloto"] = "Add driver",
        ["Agregar"] = "Add",
        ["Guardar picks"] = "Save picks",
        ["No se pudo cargar la lista de picks."] = "Couldn't load the pick list.",
        ["No se pudo guardar la lista de picks."] = "Couldn't save the pick list.",
        ["No se pudo completar el ban."] = "Couldn't complete the ban.",
        ["El ban se guardo, pero el resultado aun no se ha actualizado. Vuelve a intentarlo."] = "The ban was saved, but the result hasn't updated yet. Try again.",
        ["En drafts V2 no hay turnos: cada jugador guarda una lista privada y ordenada de picks."] = "V2 drafts have no turns: each player saves a private ordered pick list.",
        ["Al deadline se publica un resultado por posicion; una lista vacia o parcial puede producir un missed pick."] = "At the deadline, one result per slot is published; an empty or partial list can produce a missed pick.",
        ["Los bans V2 permiten elegir cualquier rival elegible durante la ventana, nunca a uno mismo ni a un companero."] = "V2 bans can target any eligible rival during the window, never yourself or a teammate.",
        ["Los picks V2 puntuan al 100%; el 50% se mantiene solo para autopick legacy."] = "V2 picks score 100%; the 50% rule remains only for legacy autopick.",
